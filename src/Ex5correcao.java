...
public class Ex5correcao {
    ...
    public Ex5correcao(String nome, String descricao, double preco, double peso, int estoque) {
	setNome(nome);
	...
	if (quantidade > 0 && quantidade <= this.estoque) { 
            ...
            System.out.println("Erro: Estoque insuficiente ou quantidade inválida para venda.");
        }
    }
    ...
    public void setPreco(double preco) {
        if (preco > 0) {
            ...
            System.out.println("Erro: O preço do produto deve ser maior que zero.");
        }
    ...
    public void setPeso(double peso) {
        if (peso > 0) {
            ...
            System.out.println("Erro: O peso do produto deve ser maior que zero.");
        }
    }
